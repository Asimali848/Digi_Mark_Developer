...
const Partner = () => {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-10 overflow-hidden md:py-4">
      ...
      <div className="flex w-full flex-col gap-5">
        ...
        >
          {partnersRow1.map((logo, index) => (
            <motion.span
              key={index}
              className="bg-gray-100 p-2 md:p-7 lg:p-10"
              onHoverStart={handleRow1HoverStart}
              onHoverEnd={handleRow1HoverEnd}
            >
              <img src={logo} alt="" className="h-[60px] w-[223.6px]" />
            </motion.span>
          ))}
        </motion.div>
